...
const STATIONS = {
  Bergen:        { x:  7, y: -60, lat: 60.39,     lon: 5.3337,    ids: ['NSR:StopPlace:548'] },
  Voss:          { x: 11, y: -60, lat: 60.6291,   lon: 6.4098,    ids: ['NSR:StopPlace:440'] },
  Flåm:          { x: 16, y: -55, lat: 60.8632,   lon: 7.1138,    ids: ['NSR:StopPlace:231'] },
  Myrdal:        { x: 16, y: -60, lat: 60.7351,   lon: 7.1230,    ids: ['NSR:StopPlace:222'] },
  Åndalsnes:     { x: 24, y: -43, lat: 62.5660,   lon: 7.6859,    ids: ['NSR:StopPlace:520'] },
  Geilo:         { x: 27, y: -60, lat: 60.5347,   lon: 8.2067,    ids: ['NSR:StopPlace:318'] },
  Hønefoss:      { x: 30, y: -63, lat: 60.1692,   lon: 10.2489,   ids: ['NSR:StopPlace:158'] },
  'Trondheim S': { x: 34, y: -34, lat: 63.436279, lon: 10.399123, ids: ['NSR:StopPlace:59977', 'NSR:StopPlace:659'] },
  Støren:        { x: 34, y: -38, lat: 63.0421,   lon: 10.2858,   ids: ['NSR:StopPlace:603'] },
  Dombås:        { x: 34, y: -47, lat: 62.0759,   lon: 9.1218,    ids: ['NSR:StopPlace:645'] },
  Vinstra:       { x: 34, y: -53, lat: 61.5944,   lon: 9.7351,    ids: ['NSR:StopPlace:425'] },
  Drammen:       { x: 34, y: -67, lat: 59.7400,   lon: 10.2050,   ids: ['NSR:StopPlace:11'] },
  Lillehammer:   { x: 37, y: -56, lat: 61.1167,   lon: 10.4612,   ids: ['NSR:StopPlace:420'] },
  Steinkjer:     { x: 38, y: -26, lat: 64.0157,   lon: 11.4998,   ids: ['NSR:StopPlace:714'] },
  Stjørdal:      { x: 38, y: -30, lat: 63.4719,   lon: 10.9249,   ids: ['NSR:StopPlace:712'] },
  Bodø:          { x: 39, y: -17, lat: 67.2851,   lon: 14.3879,   ids: ['NSR:StopPlace:507', 'NSR:StopPlace:510', 'NSR:StopPlace:58952'] },
  Narvik:        { x: 40, y: -12, lat: 68.44151,  lon: 17.441289, ids: ['NSR:StopPlace:62318'] },
  Kopperå:       { x: 40, y: -34, lat: 63.392005, lon: 11.847768, ids: ['NSR:StopPlace:62376'] },
  Hamar:         { x: 40, y: -59, lat: 60.7960,   lon: 11.0700,   ids: ['NSR:StopPlace:219'] },
  'Oslo S':      { x: 40, y: -65, lat: 59.9111,   lon: 10.7557,   ids: ['NSR:StopPlace:337'] },
  Fauske:        { x: 41, y: -19, lat: 67.2599,   lon: 15.3927,   ids: ['NSR:StopPlace:176', 'NSR:StopPlace:182', 'NSR:StopPlace:58954'] },
  'Mo i Rana':   { x: 41, y: -23, lat: 66.3145,   lon: 14.1421,   ids: ['NSR:StopPlace:195'] },
  Stavanger:     { x:  8, y: -71, lat: 58.9696,   lon: 5.7332,    ids: ['NSR:StopPlace:596'] },
  Sandnes:       { x:  8, y: -73, lat: 58.852305, lon: 5.736575,  ids: ['NSR:StopPlace:702'] },
  Egersund:      { x: 12, y: -77, lat: 58.4517,   lon: 6.0008,    ids: ['NSR:StopPlace:82'] },
  Kristiansand:  { x: 24, y: -77, lat: 58.14559,  lon: 7.988067,  ids: ['NSR:StopPlace:61608'] },
  Nelaug:        { x: 28, y: -73, lat: 58.6650,   lon: 8.6260,    ids: ['NSR:StopPlace:250'] },
  Arendal:       { x: 28, y: -75, lat: 58.4636,   lon: 8.7720,    ids: ['NSR:StopPlace:380'] },
  Røros:         { x: 43, y: -47, lat: 62.5743,   lon: 11.3823,   ids: ['NSR:StopPlace:53'] },
  Ski:           { x: 43, y: -72, lat: 59.7197,   lon: 10.8358,   ids: ['NSR:StopPlace:127'] },
  Bjørnfjell:    { x: 45, y: -12, lat: 68.432799, lon: 18.070133, ids: ['NSR:StopPlace:62317'] },
  Elverum:       { x: 45, y: -54, lat: 60.8807,   lon: 11.5631,   ids: ['NSR:StopPlace:117'] },
  Halden:        { x: 45, y: -77, lat: 59.1242,   lon: 11.3863,   ids: ['NSR:StopPlace:192'] },
  Kongsvinger:   { x: 51, y: -61, lat: 60.1900,   lon: 11.9970,   ids: ['NSR:StopPlace:635'] },
};
